package com.workshop.movieService.config;
...
public class DatabaseConfig {
    ...
    public LocalSessionFactoryBean sessionFactory(DataSource dataSource) {
        ...
        sessionFactory.setPackagesToScan("com.workshop.movieService.entity");
    ...
    public Properties hibernateProperties() {
        return new Properties() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 5399186418694423930L;
